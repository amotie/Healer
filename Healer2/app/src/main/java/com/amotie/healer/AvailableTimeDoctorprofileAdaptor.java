...
public class AvailableTimeDoctorprofileAdaptor extends RecyclerView.Adapter<AvailableTimeDoctorprofileAdaptor.ViewHolder>{
    List<String> avaialbleTimeDoctorprofileList;
    Context context;
    int row_index=-1;
    AvailableTimeDoctorprofileAdaptor(Context context,List<String> avaialbleTimeDoctorprofileList){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AvailableTimeDoctorprofileAdaptor.ViewHolder(v);
    }
