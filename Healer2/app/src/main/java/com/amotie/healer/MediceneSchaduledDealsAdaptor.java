...
public class MediceneSchaduledDealsAdaptor extends  RecyclerView.Adapter<MediceneSchaduledDealsAdaptor.ViewHolder> {
    private List<MedicineSchauledDealList> medicineSchauledDealLists;
    private Context context;
    MediceneSchaduledDealsAdaptor(List<MedicineSchauledDealList> medicineSchauledDealLists, Context context){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MediceneSchaduledDealsAdaptor.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        MedicineSchauledDealList medicineSchauledDealList=medicineSchauledDealLists.get(position);
