...
public class DoctorSchaduledDealsAdaptor extends RecyclerView.Adapter<DoctorSchaduledDealsAdaptor.ViewHolder>{

    private List<DoctorSchaduledDealsList> doctorHomeListItemList;
    private Context context;
    DoctorSchaduledDealsAdaptor(List<DoctorSchaduledDealsList> doctorHomeListItems, Context context){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new DoctorSchaduledDealsAdaptor.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        DoctorSchaduledDealsList doctorHomeListItem=doctorHomeListItemList.get(position);
